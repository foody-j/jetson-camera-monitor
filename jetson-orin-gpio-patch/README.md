...
## Test examples
You will need to reboot for the changes to take effeifct. There are sample programs taken from the Jetson.GPIO library in the examples directory, which use Pin 7 as an output and Pin 15 as in input.
